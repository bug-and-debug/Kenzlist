...
-(void) getCategories{
    RightMenuViewController *rightSideMenuViewController = (RightMenuViewController*)self.menuContainerViewController.rightMenuViewController;
    rightSideMenuViewController.arrayCategories = @[@"All", @"Applications", @"ATV / UTV", @"Auto Parts", @"Health", @"Bikes", @"Boats", @"Books", @"Cars / Trucks", @"Cell Phones", @"Clothes", @"Computers", @"Forniture", @"House Hold", @"Jewelery", @"Motorcycles", @"Instruments", @"RV's", @"Tools", @"Electronic"];
    [rightSideMenuViewController.tblMenu reloadData];
    NSIndexPath *indexPath=[NSIndexPath indexPathForRow:0 inSection:0];
    [rightSideMenuViewController.tblMenu selectRowAtIndexPath:indexPath animated:YES  scrollPosition:UITableViewScrollPositionBottom];
}
